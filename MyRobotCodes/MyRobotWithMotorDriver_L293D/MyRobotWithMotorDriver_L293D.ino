/*
The following code demonstrates basic control of the DC motors. 
Motor1 is controlled through digital pins 3 and 10. 
Motor 2 is controlled through digital pins 6 and 9. 
In addition, motor driver could be completely 
turned off using analog pin A2.

In the setup() function, 
it enables the motor driver by calling setupMotor().

In the main loop, it calls the functions 
to move the robot forward, left , 
backward and right in sequence. 
In each step, it waits for 200 milliseconds.
 */
